...
public class TrainResult
{
     ...
     *
     * @param performanceSum the new performance average
     */
     ...
     *
     * @param performanceAverageFactor the new performance average factor
     */
	...
	performanceAverage =
	    (performanceAverage + performance) / performanceAverageFactor;
	return performanceAverage;
    }
