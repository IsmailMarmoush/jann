...
public class NetworkUtils
{
	...
	if (predecessors.size() > 1)
	{
		...
		inputsConc =
		    DoubleMatrix.concatVertically(inputsConc, predLyrOutput);
	    }
	    return inputsConc;
	}
	return null;
     ...
     *
     * @param net the new fill random floor
     */
